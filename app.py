...
# summary = ""
# # ye mostly yaha se wapas url pr summary bhejne ke liye h..........
# @app.route("/posts")
# def index():
...
summary = ""
#yaha pr mostly wo server se bada text leta h I guess...............
text = ""
@app.route("/bhej", methods=['GET','POST'])
def index2():
	global text
...
def call():
	...
	got = [{"body":text}]
	# print("mila is ",mila)
	print("text is ",got['body'])
	print("yes mill gaya apan ko ",got['body']) ##ye text android side se user ne bheja wo h, isko apan nlp me bhejenge.........
	###added--------------------------------
	summary = nlp(got['body'])
	#-----------------------------------
